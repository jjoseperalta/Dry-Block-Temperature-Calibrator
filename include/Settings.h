...
private:
  ...
  static constexpr float DEFAULT_P2 = 27.0f;
  static constexpr float DEFAULT_P3 = 40.0f;
  static constexpr float DEFAULT_P4 = 0.0f;
  static constexpr float DEFAULT_MASTER_OFFSET = 0.0f;
  static constexpr float DEFAULT_TEST_OFFSET = 0.0f;
  static constexpr float DEFAULT_ALARM_UPPER = 100.0f;
  static constexpr float DEFAULT_ALARM_LOWER = 10.0f;
  static constexpr float DEFAULT_DANGER_TEMP = 40.0f;
  static constexpr float DEFAULT_SAFE_TEMP = 35.0f;
  ...
  static constexpr float DEFAULT_CALIBRATION_TOLERANCE = 0.1f;
};
